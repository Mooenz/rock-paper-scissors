...
const Rules = () => {
	...
	const imgToShow = selectedGameMode ? imgRulesBonus : imgRules;
	...
	return (
		<section className="flex items-center justify-center lg:justify-end gap-6">
			...
			<label htmlFor="my-modal" className="fixed inset-0 z-100 bg-black bg-opacity-50 opacity-0 pointer-events-none transition-opacity duration-300 peer-checked:opacity-75 peer-checked:pointer-events-auto"></label>

			<section className="bg-white absolute flex flex-col z-1000 items-center justify-center opacity-0 scale-95 pointer-events-none transition-all duration-300 peer-checked:opacity-100 peer-checked:scale-100 peer-checked:pointer-events-auto p-6 lg:p-8 md:rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-square w-full md:max-w-100 h-full md:h-fit">
